...
public class Main {
	...
	public static void testFenwickTree2D1() throws FileNotFoundException {
		...
		java.util.Scanner in = new java.util.Scanner(new FileInputStream(FOLDER + "ft2d.in"));
		java.util.Scanner out = new java.util.Scanner(new FileInputStream(FOLDER + "ft2d.out"));
		AtomicBoolean failed = new AtomicBoolean(false);
		n = in.nextInt();
		m = in.nextInt();
